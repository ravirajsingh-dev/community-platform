...
const ForgotPasswordEmailOtpModal = ({
  ...
  const handleVerifyMemberId = async (e) => {
    ...
    if (errors.length) {
      setError(
        "Please provide a valid Member ID (10-digit phone + 2-digit ID).",
      );
      return;
    }
  ...
  const handleResetPassword = async (e) => {
    ...
    if (password.length < 4 || password.length > 22) {
      setError("Password must be 4 to 22 characters long.");
      return;
    }
  ...
  const isFormValid = () => {
    if (step === 4) {
      return (
        ...
        password === confirmPassword &&
        /^[a-zA-Z0-9@#$%^&+=!*-_.]{4,22}$/.test(password)
      );
    }
    return true;
  };
        ...
        {!successMessage ? (
          ...
          >
            {step === 1 && !memberIdVerified && (
              <>
                <Form.Group className="mb-3">
                  <Form.Label htmlFor="memberId" className="auth-lable">
                    Member ID *
                  </Form.Label>
                  <Form.Control
                    type="text"
            ...
            {step === 2 && (
              <>
                <Form.Group className="mb-3">
                  <Form.Label htmlFor="email" className="auth-lable">
                    Email *
                  </Form.Label>
                  <Form.Control
                    type="email"
            ...
            {step === 3 && (
              <>
                <Form.Group className="mb-3">
                  <Form.Label htmlFor="otp" className="auth-lable">
                    Enter OTP
                  </Form.Label>
                  <Form.Control
                    type="text"
                ...
                <Form.Group className="mb-3">
                  ...
                  <InputGroup>
                    <Form.Control
                      ...
                      id="password"
                      name="password"
                      placeholder="Enter new password (4-22 characters)"
                      value={password}
                  ...
                  {password && (
                    <Form.Text
                      className={
                        password.length >= 4 && password.length <= 22
                          ? passwordMatch
                            ? "text-success"
                            : "text-danger"
                          : "text-danger"
            ...
            <div className="d-flex justify-content-between">
              ...
              {step === 1 && memberIdVerified ? (
                ...
                <Button
                  ...
                  style={{
                    marginLeft: step === 1 && !memberIdVerified ? "auto" : "0",
                  }}
                >
                  {isVerifyingMemberId ||
                  isSendingOtp ||
