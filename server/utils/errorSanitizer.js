...
/**
 * Sanitize duplicate field error messages
 * @param {string} field - The field name that has a duplicate
 * @returns {string} - Sanitized error message
 */
const sanitizeDuplicateField = (field) => {
  // Log detailed info server-side but return generic message
